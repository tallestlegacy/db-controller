...
<div class="flex flex-col overflow-auto">
	<div class="sticky top-0 flex items-center gap-4 border-b p-4 text-muted-foreground">
		<a href="/collections/{collection_name}">
			<ArrowLeft size={24} />
		</a>

		<h3 class="text-lg font-bold">{isNew ? 'New document' : 'Edit document'}</h3>
	</div>
